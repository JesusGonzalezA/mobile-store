...
export const NavBar = ({
	...
	return (
		<nav className={styles.navbar}>
			...
			{hasReturn && (
				<GhostButton onClick={handleGoBack} className={styles.return} role="link">
					<div>
...
const LogoIcon = ({ name }: { name: string }) => {
	return (
		...
		>
			...
			/>
			<path
				d="M18.4363 7.42871H21.5795V22.0001H18.4363V7.42871Z"
				fill="black"
			/>
			<path
				d="M27.2939 13.1436L27.2939 16.2868L12.7225 16.2868L12.7225 13.1436L27.2939 13.1436Z"
				fill="black"
			/>
			<path
				d="M24.0486 8.45312L26.2712 10.6757L15.9677 20.9793L13.745 18.7567L24.0486 8.45312Z"
				fill="black"
			/>
			<path
				d="M26.2715 18.7568L24.0489 20.9795L13.7453 10.6759L15.9679 8.45328L26.2715 18.7568Z"
				fill="black"
			/>
			<g clipPath="url(#clip0_33901_298)">
				<path
